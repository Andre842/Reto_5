...
public class ShowUserForm extends javax.swing.JDialog {
            ...
            while (rs.next()) {
                ...
                if (nombre.isEmpty()) {
                    ...
                    try {
                        ...
                        JOptionPane.showMessageDialog(this, "El empleado ha sido actualizado", "", JOptionPane.INFORMATION_MESSAGE);
                        this.dispose();
    ...
    public void EliminarEmpleado(){
        ...
        try {
            ...
            while (rs.next()) {
                int idEmpleado = rs.getInt("idEmp");
                String queryEliminar = "DELECT FROM empleado WHERE idEmp = '" + idEmpleado + "'";
                try {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtApellidos, javax.swing.GroupLayout.DEFAULT_SIZE, 161, Short.MAX_VALUE)
